...
// ---=== HANDLE ===---
#include    "radiobyruq\DEFINE.pwn"
#include    "radiobyruq\FUNCTIONS.pwn"
#include    "radiobyruq\COMMANDS.pwn"
#include    "radiobyruq\DIALOGS.pwn"
...
public OnFilterScriptInit()
{
    ...
    print("                                                                  ");
    print("                                                                  ");
    print("             [ALL SYSTEM VOICE LOADED, BY TEAM FARUQ  ]           "); // Disini
    print("                                                                  ");
    print("                                                                  ");
    print("                                                                  ");  
    print("[-|=====-----=====-----=====-----=====-----=====-----=====-----|-]");
